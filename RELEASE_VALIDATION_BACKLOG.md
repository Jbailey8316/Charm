...
- RELEASE BLOCKER — Suspicious Block Falling Item Persistence: create item-filled Suspicious Sand and Suspicious Gravel, allow each to fall, then brush and verify the exact stored ItemStack survives.
